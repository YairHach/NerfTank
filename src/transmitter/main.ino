...
void loop()
{
  ...
  sent_data.ch1 = map( analogRead(A0), 0, 1024, 0, 255); // Left joystick
  sent_data.ch2 = map( analogRead(A1), 0, 1024, 0, 255);
  sent_data.ch3 = map( analogRead(A3), 0, 1024, 0, 255);
  
  sent_data.ch4 = map( analogRead(A4), 0, 1024, 0, 255);
  sent_data.ch5 = digitalRead(4);
  sent_data.ch6 = push_but;
  sent_data.ch7 = digitalRead(2);
